...
let ImportCategoryUseCase = (_dec = (0, _tsyringe.injectable)(), _dec2 = function (target, key) {
  ...
  loadCategories(file) {
    return new Promise((resolve, reject) => {
      ...
      const categories = [];
      const parseFile = (0, _csvParse.parse)(); // por padrão o método já reconhece que o delimitador á a vírgula, então não precisamos passar nada
      ...
      parseFile.on("data", async line => {
        ...
        _fs.default.promises.unlink(file.path); // apagando o arquivo temporário
